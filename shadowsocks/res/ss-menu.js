	...
	require(['/res/layer/layer.js'], function(layer) {
		layer.open({
			...
			content: '<div style="padding: 50px; line-height: 22px; background-color: #393D49; color: #fff; font-weight: 300;">\
				...
				使用本插件有任何问题，可以前往<a style="color:#e7bd16" target="_blank" href="https://github.com/zusterben/plan_d/issues"><u>github的issue页面</u></a>反馈~<br><br>\
...
function LoadingSSProgress(seconds) {
	...
	if (action == 0) {
		...
		$("#loading_block2").html("<li><font color='#ffcc00'><a href='https://github.com/zusterben/plan_d' target='_blank'></font>插件工作有问题？请到<em>GITHUB</em>提交issue...</font></li>");
	} else if (action == 1) {
...
function openssHint(itemNum) {
	...
	if (itemNum == 1) {
		...
		statusmenu += "</br>&nbsp;&nbsp;&nbsp;&nbsp;wget --no-check-certificate https://raw.githubusercontent.com/zusterben/plan_d/master/history_package/"+scarch+"shadowsocks_1.5.7.tar.gz";
		...
		statusmenu += "</br>回滚其它版本号，请参考<a href='https://github.com/zusterben/plan_d/' target='_blank'><u><font color='#00F'>版本历史列表</font></u></a>";
		...
		statusmenu = "shadowsocks规则更新包括了gfwlist模式中用到的<a href='https://github.com/zusterben/plan_d/blob/master/rules/gfwlist.conf' target='_blank'><font color='#00F'><u>gfwlist</u></font></a>，在大陆白名单模式和游戏模式中用到的<a href='https://github.com/zusterben/plan_d/blob/master/rules/chnroute.txt' target='_blank'><u><font color='#00F'>chnroute</font></u></a>和<a href='https://github.com/zusterben/plan_d/blob/master/rules/cdn.txt' target='_blank'><u><font color='#00F'>国内cdn名单</font></u></a>"
